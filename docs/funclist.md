...
<table class="func-list-table">
    ...
    <tr>
        ...
        <td class="func-desc-td">
            <br />Ø 列表模式统计查看站内搜索词的搜索次数等相关指标数据 <br /><br />
            Ø 动态下载所选维度下的站内搜索词的搜索次数及相关各项流量基础指标（可选）汇总数据 <br /><br />
        </td>
    </tr>
  <tr>
        <!-- <td> 11 </td> -->
        ...
        <td class="func-desc-td">
            <span class="pro-func">Ø  列表模式统计查看站外搜索词的搜索次数等相关指标数据</span> <br /><br />
            <span class="pro-func">Ø  动态下载所选维度下的站外搜索词的搜索次数及相关各项流量基础指标（可选）汇总数据</span> <br /><br />
        </td>
    </tr>
    <tr>
        <!-- <td> 12</td> -->
