...
## 2024-08-09 付费PRO专业版漏斗分析相关功能内测版发布
...
## 2024-07-19 付费PRO专业版App崩溃分析相关功能发布

- 增加App崩溃分析相关功能,可从时间段，按时、按日、按周、按月查询分析App崩溃相关指标数据.

## 2024-06-21 付费PRO专业版自定义分析相关功能发布
...
## 2024-06-14 付费PRO专业版用户权限相关功能发布

- 接入用户权限系统，包含菜单管理、角色管理、账号管理、角色权限配置等功能.

## 2024-05-17 付费PRO专业版元数据管理相关功能升级
