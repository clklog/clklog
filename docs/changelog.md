...
## 2024-07-19 商业版App崩溃分析相关功能发布

- 增加App崩溃分析相关功能,可从时间段，按时、按日、按周、按月查询分析App崩溃相关指标数据。

## 2024-06-21 商业版自定义分析相关功能发布

- 增加自定义分析功能,可自主选择事件指标、查询维度、各种筛选条件,对埋点数据进行个性化数据分析
- 增加我的书签功能,可保存自定义分析条件并快速进入自定义分析页面进行数据查询分析

## 2024-06-14 商业版用户权限相关功能发布

- 接入用户权限系统，包含菜单管理、角色管理、账号管理、角色权限配置等功能
  
## 2024-05-17 商业版元数据管理相关功能升级
...
- [查看docker安装步骤](/installation/docker-installation.md)
