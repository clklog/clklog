...
为方便您的快速集成，在该文档我们整理了神策分析常规的SDK的下载和集成文件入口，以供参考，详细参考后续章节“[**3.埋点集成SDK及文档**](#_3埋点集成sdk及文档)”内容。
...
全埋点集成方式参考：[ClkLog 埋点集成](deployment.md#9-sdk-埋点集成)
...
   更多其他端（如Andriod、IOS、微信小程序等）自定义埋点代码接入方式请参考神策官方SDK集成文档。
...
用户关联是为了对用户进行唯一标识，提高用户行为分析的准确性。目前ClkLog集成了神策提供了简易用户关联。
